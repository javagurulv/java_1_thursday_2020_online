package student_aleksey_kodin.lesson6.day4.task_14;
...
class ArrayUtilTest {
    public static void main(String[] args) {
        ...
        arrayUtilTest.testArrayRotation();
        arrayUtilTest.testArraySort();
    }
    ...
    public void testArrayRotation() {
        ArrayUtil arrayUtil = new ArrayUtil();
        int[] testArray = arrayUtil.createArray(4);
        int firstNumber = testArray[0] = 5;
        testArray[1] = 6;
        testArray[2] = 7;
        int lastNumber = testArray[3] = 8;
        arrayUtil.arrayRotation(testArray);
        printTestResult((firstNumber == testArray[3]) && (lastNumber == testArray[0]),"rotate array test");
    }
    public void testArraySort() {
        ...
        testArray[2] = 7;
        testArray[3] = 6;
        arrayUtil.arraySort(testArray);
        printTestResult((testArray[0] == 6) && (testArray[1] == 7) && (testArray[2] == 8)
                                && (testArray[3] == 9)," array sort test");
    }
