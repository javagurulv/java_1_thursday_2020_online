...
class ProductValidatorImplTest {
    ...
    public void mixedRule1() {
        Product product = new Product("tiтлe", 0, "description");
        List<ValidationException> exceptions = validator.validate(product);
        checkResult(exceptions.size() == 2, "mixedRule1");
        checkResult(exceptions.contains(new ValidationException("RULE-4", "Title must contain only english alphabet letters and numbers", "title")), "mixedRule1");
        checkResult(exceptions.contains(new ValidationException("RULE-6", "Price must be greater than zero", "price")), "mixedRule1");
    }

    public void mixedRule2() {
        Product product = new Product("tiтлe", 5, "descript%&ion");
        List<ValidationException> exceptions = validator.validate(product);
        checkResult(exceptions.size() == 2, "mixedRule2");
        checkResult(exceptions.contains(new ValidationException("RULE-4", "Title must contain only english alphabet letters and numbers", "title")), "mixedRule2");
        checkResult(exceptions.contains(new ValidationException("RULE-8", "Description must contain only english alphabet letters and numbers", "description")), "mixedRule2");
    }

    public void mixedRule3() {
        Product product = new Product("title", -9, "descript%&ion");
        List<ValidationException> exceptions = validator.validate(product);
        checkResult(exceptions.size() == 2, "mixedRule3");
        checkResult(exceptions.contains(new ValidationException("RULE-6", "Price must be greater than zero", "price")), "mixedRule3");
        checkResult(exceptions.contains(new ValidationException("RULE-8", "Description must contain only english alphabet letters and numbers", "description")), "mixedRule3");
    }

    public void mixedRule4() {
        Product product = new Product("tiтлe", -9, "descript%&ion");
        List<ValidationException> exceptions = validator.validate(product);
        checkResult(exceptions.size() == 3, "mixedRule4");
        checkResult(exceptions.contains(new ValidationException("RULE-4", "Title must contain only english alphabet letters and numbers", "title")), "mixedRule4");
        checkResult(exceptions.contains(new ValidationException("RULE-6", "Price must be greater than zero", "price")), "mixedRule4");
        checkResult(exceptions.contains(new ValidationException("RULE-8", "Description must contain only english alphabet letters and numbers", "description")), "mixedRule4");
    }
