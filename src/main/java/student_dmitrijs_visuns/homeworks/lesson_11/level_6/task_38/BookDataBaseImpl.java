package student_dmitrijs_visuns.homeworks.lesson_11.level_6.task_38;
...
class BookDataBaseImpl  implements BookDataBase {
    ...
    @Override
    public Map<String, List> getAuthorToBooksMap() {
        Map<String, List> authorBooksMap = new HashMap<>();
        for (Book book : booksList) {
            authorBooksMap.put(book.getAuthor(), findByAuthor(book.getAuthor()));
    ...
    public Map<String, Integer> getEachAuthorBookCount() {
        ...
        for (Book book : booksList) {
            List<Book> eachAuthorBooks = findByAuthor(book.getAuthor());
            authorBooksCount.put(book.getAuthor(), eachAuthorBooks.size());
