...
class WordServiceTest {
    ...
    public void textToWordArrayTestV1(){
        ...
        String[] testArray = test.transformTextToWordArray("1, 2, 3, 4, 5");
    ...
    public void textToWordArrayTestV2(){
        WordService test = new WordService();
        String[] testArray = test.transformTextToWordArray("Hello! How are you?");
        int result = testArray.length;
    ...
    public void findWordTestV1(){
        WordService test = new WordService();
        String[] testArray = test.transformTextToWordArray("Hello, hello! How are you?");
    ...
    public void findWordTestV2(){
        WordService test = new WordService();
        String[] testArray = test.transformTextToWordArray("Hello, hello! How how are are are you?");
        String result = test.findWord(testArray);
