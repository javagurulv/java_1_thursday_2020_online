...
class FloodRiskCoeficientDetector {

    private static final BigDecimal STANDARD_FIRE_RISK_COEF = new BigDecimal("0.04");
    private static final BigDecimal OVERPRICED_FIRE_RISK_COEF = new BigDecimal("0.06");
    private static final BigDecimal PRICE_BORDER = new BigDecimal("3000.00");
