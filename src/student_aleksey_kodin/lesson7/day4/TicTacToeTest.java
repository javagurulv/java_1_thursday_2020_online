...
class TicTacToeTest {
    ...
    public void testWinPositionForHorizontals() {
        ...
        createPlayBoard(field);
        field[1][2] = field[1][1] = 1;
        printGameBoard(field);
        boolean resultNoWinPosition = ticTacToe.isWinPositionForHorizontals(field,1);
    ...
    public void testWinPositionForVerticals() {
        ...
        createPlayBoard(field);
        field[2][1] = field[1][1] = 1;
        printGameBoard(field);
        boolean resultNoWinPosition = ticTacToe.isWinPositionForVerticals(field,1);
    ...
    public void testisWinPosition() {
        ...
        field[1][0] = -1;
        printGameBoard(field);
        boolean resultHorizontalFirstVariant = ticTacToe.isWin(field,0);
        ...
        field[1][1] = -1;
        printGameBoard(field);
        boolean resultHorizontalSecondVariant = ticTacToe.isWin(field,1);
        ...
        field[2][2] = -1;
        printGameBoard(field);
        boolean resultHorizontalThirdVariant = ticTacToe.isWin(field,1);
        ...
        field[2][0] = -1;
        printGameBoard(field);
        boolean resultVerticalFirstVariant = ticTacToe.isWin(field,0);
        ...
        field[1][1] = -1;
        printGameBoard(field);
        boolean resultVerticalSecondVariant = ticTacToe.isWin(field,0);
        ...
        field[0][2] = -1;
        printGameBoard(field);
        boolean resultVerticalThirdVariant = ticTacToe.isWin(field,0);
        ...
        field[1][1] = -1;
        printGameBoard(field);
        boolean resultDiagonalFirstVariant = ticTacToe.isWin(field,0);
        ...
        field[2][2] = -1;
        printGameBoard(field);
        boolean resultDiagonalSecondVariant = ticTacToe.isWin(field,0);
        ...
        field[0][0] = -1;
        printGameBoard(field);
        boolean resultDiagonalThirdVariant = ticTacToe.isWin(field,0);
        ...
        field[2][0] = -1;
        printGameBoard(field);
        boolean resultDiagonalFourthVariant = ticTacToe.isWin(field,0);
        ...
        field[1][1] = -1;
        printGameBoard(field);
        boolean resultDiagonalFifthVariant = ticTacToe.isWin(field,0);
        ...
        field[0][2] = -1;
        printGameBoard(field);
        boolean resultDiagonalSixthVariant = ticTacToe.isWin(field,0);
    ...
    public void testisDrawPosition() {
        ...
        printGameBoard(field);
        boolean resultDraw = ticTacToe.isDraw(field);
        ...
        printGameBoard(field);
        boolean resultDrawSecond = ticTacToe.isDraw(field);
        printTestResult(resultDrawSecond,"draw position ");
    }
    public void testCreateField() {
        int [][] tempArray = ticTacToe.createField();
        printTestResult(tempArray.length == 3 && tempArray[0].length == 3,"create field ");
    }
